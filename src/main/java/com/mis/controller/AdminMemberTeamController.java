...
@Controller
@RequestMapping("admin/mypage/myTeam/*")
public class AdminMemberTeamController {

	   private static final Logger logger = LoggerFactory.getLogger(AdminMemberTeamController.class);
	  ...
	  @Inject
	   ...
	   public String registerPOST(MemberTeamVO mt, RedirectAttributes rttr) throws Exception {
	      ...
	      return "redirect:/admin/mypage/myInfo";
	   }
}
