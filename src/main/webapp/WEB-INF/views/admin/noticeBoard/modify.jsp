                     ...
                     <div class="form-group">
                        <label for="exampleInputEmail1">닉네임: ${login.nickname}</label>
							...
							<div class="form-group">
								<label for="exampleInputEmail1">내용</label> <input type="text"
									...
									value="${noticeBoardVO.content}">
							</div>
							&nbsp;&nbsp;
								 <label for="read">말머리</label> <select id="mustRead"
								name="mustRead" size="1">
								<option value="">선택하세요.</option>
								<option selected="selected" value="1">필독</option>
						...
						<div>
							...
							<ul class="dropzone-previews clearfix uploadedList">
								...
								<c:forEach items="${nbFileVO}" var="fVo" varStatus="status">
						...
						function() {
							...
							$(".btn-warning")
									.on(
											"click",
											function() {
												self.location = "/admin/noticeBoard/list?page=${cri.page}&perPageNum=${cri.perPageNum}"
