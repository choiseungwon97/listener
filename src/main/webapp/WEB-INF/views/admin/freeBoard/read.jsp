...
<html>
<head>
<title>LISTENER 자유게시판 상세보기</title>
<meta charset="utf-8" />
<meta name="viewport"
...
<body class="is-preload">
         ...
         <div class="inner">
            ...
            <header id="header">
               ...
               <form role="form" action="modify" method="post">
                  ...
                  <input type='hidden' id='fbNo' name='fbNo' value="${freeBoardVO.fbNo}">
                  <input type="hidden"
                  id='id' name="id" value="${freeBoardVO.id}">
               ...
               <div class="box-body">
                  <div class="form-group">
                     <label for="exampleInputEmail1">제목</label> <input type="text"
                        name='title' class="form-control" value="${freeBoardVO.title}"
                        readonly="readonly">
                  </div>
                   &nbsp;&nbsp;
                     <div class="form-group">
                        <label for="exampleInputEmail1">닉네임: ${freeBoardVO.nickname}</label>
                     </div>
                  <div class="form-group col-md-6">
                     <label for="inputCity" class="col-form-label">작성일</label>
                     <fmt:formatDate value="${freeBoardVO.regdate}" type="date"
                  ...
                  <div class="form-group">
                     ...
                     <label for="exampleInputEmail1" name="contnet" id="content">내용</label>
                     <c:if test="${ null eq  freeBoardVO.youtubeLink}">
                        <div></div>
                     </c:if>
                     <c:if test="${ null ne  freeBoardVO.youtubeLink}">
                        <iframe width="560" height="315"
                           src="${freeBoardVO.youtubeLink}" title="YouTube video player"
                           frameborder="0"
                           allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                           allowfullscreen></iframe>
                     </c:if>
                     <textarea readonly="readonly">${freeBoardVO.content}</textarea>
                     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  ...
                  <c:if test="${!empty fbFileVO}">
                     ...
                     <ul class="dropzone-previews">
                        ...
                        <c:forEach items="${fbFileVO}" var="fbFileVO" varStatus="status">
                           <c:set var="fileName" value="${fbFileVO.filename}" />
                              ...
                              <div
                                 ...
                                 <div class="p-2">
                                    <div class="row align-items-center">
                                       <c:forTokens var="token" items="${fbFileNo}" delims="."
                                          varStatus="status">
                                             ...
                                             <c:choose>
                                                ...
                                                <c:when
                                                   ...
                                                   <img data-dz-thumbnail=""
                                                      class="avatar-sm rounded bg-light"
                                                      src="/displayFile?fileName=${fbFileVO.fileLocation}">
                                                </c:when>
                                       ...
                                       <div class="col pl-0">
                                          <a href="/displayFile?fileName=${fbFileVO.fileLocation}"
   ...
   <script>
      var fbNo = $("#fbNo").val(); //  자유게시글 번호
      var loginNo = $("#newUserNo").val(); //로그인 사랑 정보
      var writeUser = $("#id").val(); //게시글 쓴 사람 정보 가져오기

      $.getJSON("/fbComment/all/" + fbNo, function(data) {
         var str = "";
         $(data).each(
               function() {

                  var strbutton = "";
                  str += "<li data-fbCommNo='" + this.fbCommNo + ">"
      ...
      function deleteReply(fbCommentNo) {

         $.ajax({
            type : 'delete',
            url : '/fbComment/' + fbCommentNo,
            headers : {
               "Content-Type" : "application/json",
   ...
   <script>
      $(document).ready(function() {
         ...
         $(".btn-warning").on("click", function() {
            formObj.attr("action", "/admin/freeBoard/modify");
            formObj.attr("method", "get");
            formObj.submit();
         });

         $(".btn-danger").on("click", function() {
            formObj.attr("action", "/admin/freeBoard/remove");
            formObj.submit();
         });

         $(".btn-primary").on("click", function() {
            formObj.attr("method", "get");
            formObj.attr("action", "/admin/freeBoard/list");
            formObj.submit();
         });
