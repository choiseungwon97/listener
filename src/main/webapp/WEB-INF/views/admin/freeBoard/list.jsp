                     ...
                     <div class='col-3 col-12-small'>
                        <select name="searchType">
                           ...
                           <option value="c"
                              ...
                              내용</option>
                           <option value="tnc"
                              <c:out value="${cri.searchType eq 'tnc'?'selected':''}"/>>
                              모두</option>
                        </select>
                        </div>
							<div class='col-3 col-12-small'>
		...
		<section>
					...
					<table class="alt">
						...
						<tbody>
							...
							<c:forEach items="${list}" var="FreeBoardVO" varStatus="var">
								...
								<tr>
									...
									<td><a
										href='/admin/freeBoard/read${pageMaker.makeSearch(pageMaker.cri.page) }&fbNo=${FreeBoardVO.fbNo}'>
											${FreeBoardVO.title} </a></td>
									<td>${FreeBoardVO.nickname}</td>
									<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm"
											value="${FreeBoardVO.regdate}" /></td>
									<td><span class="badge bg-red">${FreeBoardVO.viewcnt }</span></td>
								</tr>
