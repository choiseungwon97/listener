                        ...
                        <div class="form-row">
                                 <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <div class="input-group-append">
                                             ...
                                             <button class="btn btn-primary" type="button" onClick="window.open('/admin/mypage/myTeam/searchPopup?id=${login.id}', 'CLIENT_WINDOW',
                              ...
                              <div style="text-align: right;">
                                 <button type="submit" class="btn btn-primary">등록</button>
                                  <button type="button" onclick="location.href='/admin/mypage/myInfo' ">취소</button>
                              </div>
                           </form>
                  ...
                  $("#carPopup")
                        .click(
                              function() {
                                 ...
                                 window.open( "/admin/mypage/myTeam/searchPopup?make_date="
                                                   + make_date,
                                             "_blank",
                                             "width=400, height=600, menubar=no, status=no, toolbar=no");
