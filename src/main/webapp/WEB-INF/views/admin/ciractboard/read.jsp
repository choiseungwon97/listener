      ...
      <div id="main">
         <div class="inner">
            ...
            <form role="form" action="modify" method="post">
               ...
               <input type='hidden' id='cabNo' name='cabNo'value="${ciractBoardVO.cabNo}"> 
               <input type="hidden" id='id' name="id" value="${ciractBoardVO.id}"> 
            ...
            <form>
               <div class="box box-primary">
                  ...
                  <div class="form-group">
                     ...
                     <textarea readonly="readonly">${ciractBoardVO.content}</textarea>
                     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<script>
   $(document).ready(function() {
      ...
      $(".btn-success").on("click", function() {
         formObj.attr("action", "/admin/ciractboard/modify");
      ...
      $(".btn-light").on("click", function() {
         formObj.attr("method", "get");
         formObj.attr("action", "/admin/ciractboard/list");
         formObj.submit();
      });
      /* 삭제버튼 */
      $(".btn-danger").on("click", function() {
         formObj.attr("action", "/admin/ciractboard/remove");
         formObj.submit();
      });
