...
<html>
<head>
<title>LISTENER 동아리활동 게시판 수정</title>
<meta charset="utf-8" />
<meta name="viewport"
               ...
               <ul class="icons">
				...
				<div class="box box-primary">
					...
					<form role="form" method="post" name="frm">
						<input type='hidden' name='cabNo' value="${ciractBoardVO.cabNo}">
						...
						<div class="box-body">
							<div class="form-group">
								...
								id="title"	name='title' class="form-control"
									value="${ciractBoardVO.title}" id="title">
							</div>
							&nbsp;&nbsp;
							
								<div class="form-group">
								<label for="exampleInputPassword1">작성자</label> <label
									for="exampleInputPassword1">${login.nickname}</label>
							</div>
							&nbsp;&nbsp;
							<div class="form-group">
								<label for="exampleInputPassword1">내용</label>
								<textarea class="form-control" name="content" id="content"
									rows="3">${ciractBoardVO.content}</textarea>
							</div>

							<div class="form-group">
                     <label for="exampleInputEmail1">유튜브링크</label> <input type="text"
                        name='youtubeLink' class="form-control"
                        value="${ciractBoardVO.youtubeLink}">
                  </div>
							...
							<div id='mydropzone' class="dropzone" style="height: auto; width: 100%; border:1px solid #bcbcbc;">
										...
										<div>
											...
											<ul class="dropzone-previews clearfix uploadedList">
												...
												<c:forEach items="${cabFileVO}" var="fVo" varStatus="status">
														...
														<div
															...
															<div class="p-2">
																<div class="row align-items-center">
																	<c:forTokens var="token" items="${cabFileNo}" delims="." varStatus="status">
