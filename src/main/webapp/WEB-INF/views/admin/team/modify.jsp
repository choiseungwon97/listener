               ...
               <div class="box-body">
                  <div class="form-group">
                     <label for="exampleInputEmail1">팀명</label> <input type="text"
                        class="form-control" value="${teamVO.teamName}" readonly="readonly">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">장르</label> <input type="text"
                        name='genre' class="form-control" value="${teamVO.genre}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">팀장</label> <input type="text"
                        name='captain' class="form-control" value="${teamVO.captain}">
                  </div>
                     <div class="form-group">
                     <label for="exampleInputEmail1">팀장번호</label> <input type="text"
                        name='captainPh' class="form-control" value="${teamVO.captainPh}">
                  </div>
               
                  <div class="form-group">
                     <label for="exampleInputEmail1">보컬</label> <input type="text"
                        name='vocal' class="form-control" value="${teamVO.vocal}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">보컬2</label> <input type="text"
                        name='vocal2' class="form-control" value="${teamVO.vocal2}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">기타</label> <input type="text"
                        name='guitar' class="form-control" value="${teamVO.guitar}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">기타2</label> <input type="text"
                        name='guitar2' class="form-control" value="${teamVO.guitar2}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">드럼</label> <input type="text"
                        name='drum' class="form-control" value="${teamVO.drum}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">베이스</label> <input type="text"
                        name='bass' class="form-control" value="${teamVO.bass}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">신디</label> <input type="text"
                        name='synth' class="form-control" value="${teamVO.synth}">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputEmail1">extra</label> <input type="text"
                        name='extra' class="form-control" value="${teamVO.extra}">
                  
                  <div class="form-group">
                     <label for="exampleInputEmail1">합주곡</label> <input type="text"
                        name='song' class="form-control" value="${teamVO.song}">
                  </div>
                  
                  </div>
                     <div class="form-group">
                     <label for="read">팀 멘토 여부</label> 
                     <select id="mentor" name="mentor" size="1">
...
$(document).ready(
   function() {
      ...
      $(".btn-warning")
            .on("click",function() {
               self.location = "/admin/team/list?page=${cri.page}&perPageNum=${cri.perPageNum}"
