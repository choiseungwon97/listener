                  ...
                  <div class="box-body">
                     <div class="form-group">
                        <label for="exampleInputEmail1">팀명</label> <input type="text"
                           name='teamName' id="teamName" class="form-control" placeholder="Enter Teamname">
                     </div>
                     &nbsp;&nbsp;
                     <div class="form-group">
