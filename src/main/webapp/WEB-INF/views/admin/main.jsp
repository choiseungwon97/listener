...
<meta charset="utf-8" />
<meta name="viewport"
   content="width=device-width, initial-scale=1, admin-scalable=no" />
   ...
   <div id="wrapper">
      ...
      <div id="main">
         <div class="inner">
            ...
            <hr>
            <h2><font>필독 공지사항</font></h2>
            <table>
            <colgroup> <col style="width:5%" > <col style="width:30%"> <col style="width:5%"> </colgroup>
               <thead>
                  <tr>
                     <th>작성자</th>
                     <th>제목</th>
            ...
            <c:forEach items="${list}" var="NoticeBoardVO" varStatus="status">
                  <c:if test="${ 1 eq  NoticeBoardVO.mustRead}">
                     ...
                     <td><a
                        href='/admin/noticeBoard/read${pageMaker.makeSearch(pageMaker.cri.page) }&nbNo=${NoticeBoardVO.nbNo}'>
